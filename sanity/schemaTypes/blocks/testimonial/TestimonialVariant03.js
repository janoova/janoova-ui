...
const TestimonialVariant03 = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "boolean",
      initialValue: false,
      description: "When enabled, the inline content below is ignored.",
      group: "content",
    }),
    defineField({
    ...
    defineField({
      name: "global_testimonial_index",
      title: "Testimonial Number",
      type: "number",
      initialValue: 1,
      description: "Which testimonial to show from the global list (1 = first).",
      group: "content",
      hidden: ({ parent }) => !parent?.use_global_testimonials,
    }),
    defineField({
