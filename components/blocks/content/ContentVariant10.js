...
import BackgroundImageCard from "@/components/ui/BackgroundImageCard";

const Wrapper = styled.div`
  .b__content__variant10 {
    &__row {
      --bs-gutter-x: 2rem;
      --bs-gutter-y: 2rem;
    }
...
const ContentVariant10 = ({ data = {}, index }) => {
  ...
  return (
    <Bounded
      ...
      className="b__content__variant10 overflow-hidden relative"
    >
      ...
      <Wrapper>
        ...
        {data.repeater && (
          <div className="container relative u__z-index-1 mt-[2.5rem]">
            <div
              className={`row b__content__variant10__row justify-${getCleanValue(data.justify_content)}`}
            >
                  ...
                  <div key={index} className={columnClassName}>
                    ...
                    >
                      <BackgroundImageCard
                        ...
                        headingSize={data?.card_heading_size || "h4"}
...
export default ContentVariant10;
