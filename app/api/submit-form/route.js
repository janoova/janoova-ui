  ...
  try {
    ...
    const emailHtml = `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
        <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px;padding-bottom:16px;border-bottom:2px solid #eee">
          <img src="https://cdn.sanity.io/images/l0za69l5/production/bca4ca7fbdfc8fffb71861187884056a822530a1-1925x1926.png" alt="Janoova" width="36" height="36" style="border-radius:8px;display:block;flex-shrink:0;vertical-align:middle" />
          <span style="font-size:15px;font-weight:600;color:#333;line-height:36px">Janoova Forms</span>
        </div>
